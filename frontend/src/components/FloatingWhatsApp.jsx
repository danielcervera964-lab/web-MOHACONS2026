...
const FloatingWhatsApp = () => {
  const message = "Hola, me gustaría información sobre sus servicios de construcción.";
  const waLink = `https://wa.me/${mockData.company.whatsapp}?text=${encodeURIComponent(message)}`;
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center group">
      ...
      <div className="relative">
        ...
        <a 
          ...
          className="relative flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#20b858] transition-transform hover:scale-110 duration-300"
          aria-label="Contactar por WhatsApp"
        >
          {/* Icono de WhatsApp en SVG (No depende de librerías externas) */}
          <svg
